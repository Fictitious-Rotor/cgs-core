...
public class ToLightRange extends RangeCommons {
    @Override
    protected void handlePlayerCommand(final Player runningPlayer,
                                       final Command command,
                                       final String aliasUsed,
                                       final String[] args) {
        performRangeOperation(runningPlayer, LightUtils::convertBlockIntoLight, ReportUtils::reportMassLightification);
    }
}
