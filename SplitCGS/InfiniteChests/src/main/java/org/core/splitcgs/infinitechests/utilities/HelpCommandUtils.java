...
public final class HelpCommandUtils {
    private static String formatCommandAndArguments(final String pluginName, final String name, final String arguments) {
        return String.format("%s/%s %s %s%s", ChatColor.GRAY, pluginName, name, ChatColor.WHITE, arguments);
    }
