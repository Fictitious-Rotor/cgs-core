...
public class ReportUtils {
    ...
    public static void reportMassIdentification(final PrimedPLI PPLI, final int noOfConvertedBlocks) {
        PPLI.sendToPlayer(String.format("Managed to identify %s light sources", noOfConvertedBlocks));
    }

    public static void reportMassRemoval(final PrimedPLI PPLI, final int noOfConvertedBlocks) {
        PPLI.sendToPlayer(String.format("Managed to remove %s light sources", noOfConvertedBlocks));
    }
}
